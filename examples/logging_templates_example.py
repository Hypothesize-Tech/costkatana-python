...
def main():
    ...
    ck.configure(api_key="dak_your_key_here", enable_ai_logging=True, log_level="debug")
    ...
    session.send(
        "",
        template_id="greeting",
        template_variables={"style": "professional", "name": "Bob"},
    )
...
Focus on: {{focus_areas}}""",
    ...
    resolution = tm.resolve_template(
        "code-review",
        {
            "language": "Python",
