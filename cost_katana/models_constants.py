...
class aws_bedrock:
    ...
    claude_3_5_sonnet_extended_access = (
        "anthropic.claude-3-5-sonnet-extended-access-v1:0"
    )
    claude_3_5_sonnet_v2_extended_access = (
        "anthropic.claude-3-5-sonnet-v2-extended-access-v1:0"
    )
    ...
    stable_image_conservative_upscale = (
